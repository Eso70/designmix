...
export const DeleteLinktreeModal = memo(function DeleteLinktreeModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Content */}
        <div className="p-6 sm:p-8 md:p-10 bg-linear-to-br from-white to-slate-50/20">
          {/* Warning Icon */}
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-linear-to-br from-rose-50 to-pink-50 border-2 border-rose-100 flex items-center justify-center shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              onClick={onClose}
              disabled={isDeleting}
              className="flex-1 px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl bg-linear-to-br from-slate-50 to-gray-50 hover:from-slate-100 hover:to-gray-100 border border-slate-100 text-slate-600 hover:text-slate-700 font-medium font-kurdish transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base shadow-sm hover:shadow"
            >
              هەڵوەشاندنەوە
            </button>
            <button
